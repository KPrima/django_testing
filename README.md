...
По ходу учебного спринта были написаны тесты для двух проектов:
- Полигоном для тестов на pytest стал Django-проект YaNews: новостной сайт, где пользователи могут оставлять комментарии к новостям.для
- Тестирование Django-проекта YaNote - онлайн версии записной книжки - на unittest.
